    ...
    class empresa{
        ...
        */
        public function selectAll($where = ""){
            /** Realiza el query */
            $sql = "SELECT Id, Imagen, Titulo, Descripcion, Titulo_benef, Beneficios, Direccion, Telefono, Email, Status,  Created_by, Created_date, Updated_by, Updated_date
        ...
        */
        public function pagerCount($page){
            $sql = "SELECT  count(*) as num FROM empresa Where Status = 1";
            $result = $this->db->ejecutar($sql);
