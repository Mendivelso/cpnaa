    ...
    class experiencia{
        ...
        */
        public function selectAll($where = ""){
             /** Realiza el query */
                $sql = "SELECT Id, Titulo, Descripcion, Enlace, Imagen, Documento, R_Legal,  Status, Created_by, Created_date,
        ...
        */
        public function pagerCount($page){
            $sql = "SELECT  count(*) as num FROM experiencias Where Status = 1";
            $result = $this->db->ejecutar($sql);
