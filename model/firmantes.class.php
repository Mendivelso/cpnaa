    ...
    class firmante{
        ...
        */
        public function selectAll($where = ""){
            /** Realiza el query */
            $sql = "SELECT Id, Razon_social, Nit, Telefono_emp, Pagina_web, Nombre_Repre, Cedula_Repre, Telefono_Repre, Email_Repre, Responsable_pacto, Cedula_Res, Telefono_Res, Email_Res, Status,
